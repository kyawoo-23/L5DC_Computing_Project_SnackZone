...
CREATE TABLE `adminrole` (
  ...
  `AdminRoleName` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`AdminRoleId`),
  UNIQUE KEY `AdminRole_AdminRoleName_key` (`AdminRoleName`)
...
INSERT INTO `adminrole` VALUES ('clqqorxh30000j6r0zetxgulw','Admin'),('clqqorxhb0001j6r0hg3eyhd4','Staff');
